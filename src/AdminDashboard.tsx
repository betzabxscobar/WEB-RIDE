...
type SidebarIconName = 'dashboard' | 'user' | 'wheel' | 'gps' | 'money' | 'help' | 'logout' | 'key'
...
function SidebarIcon({ name }: { name: SidebarIconName }) {
  ...
  const paths = {
    ...
    gps: <><path d="M12 21s7-5.2 7-11a7 7 0 1 0-14 0c0 5.8 7 11 7 11Z" /><circle cx="12" cy="10" r="2.5" /></>,
